...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        // Digər inisializasiyalar...

        // Column resizers-i işə sal
        if (typeof window.initializeColumnResizers === 'function') {
            console.log('📏 ColumnResizers funksiyası tapıldı, işə salınır...');
            window.initializeColumnResizers();
        } else if (typeof window.setupColumnResizing === 'function') {
            console.log('📏 setupColumnResizing funksiyası tapıldı, işə salınır...');
            window.setupColumnResizing();
        } else {
            console.warn('⚠️ ColumnResizer funksiyaları tapılmadı');
            // Əl ilə çağıra bilərik
            setTimeout(function() {
                const script = document.createElement('script');
                script.src = '../assets/js/task_js/columnResizer.js';
                script.onload = function() {
                    console.log('✅ ColumnResizer yenidən yükləndi');
                    if (typeof window.initializeColumnResizers === 'function') {
                        window.initializeColumnResizers();
                    }
                };
